...
// patch sanctuary area-zone-map
bool ChatHandler::HandleReloadCustomSanctuaryCommand(char* /*arg*/)
{
...
bool ChatHandler::HandleChatSpyCancelCommand(char* args)
{
    ...
    if(target->m_chatSpyGuid == m_session->GetPlayer()->GetObjectGuid().GetCounter())
